...
SECRET_KEY = 'django-insecure-hzsga-j6-!ogmy=pum-esz*fl0aay^rk1j+00oclad&yy-dyus'
...
# Así sería para Docker + Postgres
# DATABASES = {
#     'default': {
...
CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^https://proyecto-gestion-de-tareas-.*\.vercel\.app$",
]
